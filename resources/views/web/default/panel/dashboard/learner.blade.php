                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="font-30 text-primary line-height-1">
                            ...
                            <span class="font-16 text-secondary font-weight-bold">{{__('admin/main.student')}}</span>
                        </h2>
                    </div>
                    <div>
...
<div class="flex-fill row m-2 mt-4">
 
<!-- This is the second row -->


    <div class="flex-fill col-lg-6 col-md-6 col-sm-6" >
        {{-- <div class="row m-0 mt-4 justify-content-between align-items-center">
            <h3 class="text-gray-800">{{__('admin/main.courses')}}</h3>
            
        </div> --}}
    <div class="row">
        {{-- <div class="mt-4 col-lg-6 col-md-6 col-sm-6">
            <h3 class="text-dark-blue ">{{__('admin/main.courses')}}</h3>
            <div class="mt-2">
            <x-card-summary-stats2 title="{{__('update.total_courses')}}" value="{{ $purchasedCount. ' ' . __('admin/main.courses') }}" />
            </div>
        </div> --}}
    ...
    {{-- <div class="row">
        ...
        @include('web.default.panel.dashboard.currentCuourses')
        </div>
