...
<div style="display:flex" class="skills bg-white noticeboard rounded-sm panel-shadow py-10 py-md-20 px-15 px-md-30 heightDiary">
    <div style="flex: 1">
    ...
    <canvas style="height: 100%" id="organizationCanvasStatistic"></canvas>
    ...
    <script>
        ...
        function makeStatisticsChart() {
            ...
            // Buat chart baru
            chart = new Chart(organizationCanvasStatistic, {
                type: "bar",
                data: {
                    labels: sortedLabels,
                    datasets: [{
                ...
                options: {
                    ...
                    scales: {
                        yAxes: [{
                            ticks: { stepSize: 10 } // Sesuaikan dengan kebutuhan Anda
                        }],
                        xAxes: [{
                            display: false,
                            gridLines: {
