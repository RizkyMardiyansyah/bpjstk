...
<div class="flex-fill row m-2 mt-4">
    ...
    <div class="flex-fill col-lg-3 col-md-6 col-sm-12  ">
        <div class="mt-2">
...
<!-- This is the second row -->
    ...
    <div class="flex-fill col-lg-6 col-md-6 col-sm-12">
        ...
        <div class="mt-2">
            <x-card-summary  value="{{ $totalCount }} {{ trans('admin/main.students') }}" icon="student.svg" />
        </div>
    </div>
    ...
    <div class="  flex-fill col-sm-12 col-md-6 col-lg-6">
    <div class="mt-4">
        @include('web.default.panel.dashboard.noticeboard')
    </div>
    </div>
