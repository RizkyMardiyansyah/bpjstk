                                ...
                                @foreach($users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @php
                                            $activeMeetingTimeIds = App\Models\ReserveMeeting::where('user_id', $user->id)
                                                ->whereHas('sale', function ($query) {
                                                    $query->whereNull('refund_at');
                                                })
                                                ->pluck('meeting_time_id');
                                            $activeMeetingTimes = App\Models\MeetingTime::whereIn('id', $activeMeetingTimeIds)->get();
                                        ...
                                        <td class="text-right align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="/panel/manage/students/{{ $user->id }}/delete" class="webinar-actions d-block mt-10 read-action">{{ trans('public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
