...
@section('content')
    ...
    <section class="mt-35">
                        ...
                        <div class="table-responsive">
                            <table class="table custom-table text-center ">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center text-gray">{{ trans('diary.diary') }}</th>
                                    <th class="text-center text-gray">{{ trans('home.hours_session') }}</th>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            @php
                                                $diaryCount = App\Models\Diary::whereHas('user', function ($query) use ($user) {
                                                    $query->whereIn('user_id', [$user->id]);
                                                })->count();
                                            @endphp
                                            <span class="text-dark-blue font-weight-500">{{ $diaryCount }}</span>
                                            </td>
        ...
        <!-- Tampilkan hasil yang telah dibulatkan -->
        <td class="align-middle">
            <span class="text-dark-blue font-weight-500">{{ $activeHoursCount . ' ' . __('home.hours') }}</span>
        </td>
                                        ...
                                        <td class="text-right align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a href="/panel/manage/instructors/{{ $user->id }}/delete" class="webinar-actions d-block mt-10 read-action">{{ trans('public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
