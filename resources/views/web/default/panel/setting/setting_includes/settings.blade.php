...
<section class="mt-30">
    <h2 class="section-title after-line">{{ trans('public.extra_information') }}</h2>
    ...
    <div class="row mt-20">
        <div class="col-12 col-lg-4">
            ...
            <div class="form-group mb-30">
                <label class="input-label">{{ trans('meeting.type_session') }}:</label>

                <div class="d-flex align-items-center">


                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" name="type_of_sessions[]" value="coaching" id="coaching" {{ (!empty($user->type_of_sessions) and is_array($user->type_of_sessions) and in_array('coaching',$user->type_of_sessions)) ? 'checked="checked"' : ''}} class="custom-control-input">
                        <label class="custom-control-label font-14 cursor-pointer" for="coaching">{{ trans('meeting.coaching') }}</label>
                    </div>

                    <div class="custom-control custom-checkbox ml-10">
                        <input type="checkbox" name="type_of_sessions[]" value="mentoring" id="mentoring" {{ (!empty($user->type_of_sessions) and is_array($user->type_of_sessions) and in_array('mentoring',$user->type_of_sessions)) ? 'checked="checked"' : ''}} class="custom-control-input">
                        <label class="custom-control-label font-14 cursor-pointer" for="mentoring">{{ trans('meeting.mentoring') }}</label>
                    </div>

                    <div class="custom-control custom-checkbox ml-10">
                        <input type="checkbox" name="type_of_sessions[]" value="training" id="training" {{ (!empty($user->type_of_sessions) and is_array($user->type_of_sessions) and in_array('training',$user->type_of_sessions)) ? 'checked="checked"' : ''}} class="custom-control-input">
                        <label class="custom-control-label font-14 cursor-pointer" for="training">{{ trans('meeting.training') }}</label>
                    </div>
                </div>
            </div>
            <div class="form-group mb-30">
    ...
    <div class="row mt-30">
        <div class="col-12 col-lg-4">
            ...
            <div class="form-group mb-30">
                ...
                <textarea rows="5" type="text" name="address" value="{{ !empty($user->address) ? $user->address : '' }}" class="form-control"></textarea>
            </div>
        </div>
