<style>
  ...
  background-image: linear-gradient(135deg, #C97F10, #E3D800);
}
</style>
...
@section('content')
    ...
    @endif
    <div class="bg-white">
        <div style="display: flex; align-items: center; " class="row mt-0 p-20 pl-10 pr-10 p-lg-40 pl-lg-80 pr-lg-80">
            <div style="padding: 20px" class="col-lg-6 col-12 d-flex flex-column">
            ...
            <div style="padding: 20px" class="col-lg-6 col-12">
                <h1 class="text-secondary font-weight-bold">{{ trans('home.contributor_title') }}</h1>
                <p style="font-size: 16px;" class="slide-hint text-gray mt-20 mb-20">{{ trans('home.contributor_hint') }}</p>
                <div class="ml-lg-10 mt-15">
                    
                    <p class="slide-hint text-gray second"><img class=" mr-lg-2" src="/assets/default/img/icons/check.svg">{{ trans('home.contributor_text1') }}</p>
                </div>
                <div class="ml-lg-10 mt-15">
                    
                    <p class="slide-hint text-gray second"><img class=" mr-lg-2" src="/assets/default/img/icons/check.svg">{{ trans('home.contributor_text2') }}</p>
                </div>
                <div class="ml-lg-10 mt-15">
                    
                    <p class="slide-hint text-gray second"><img class=" mr-lg-2" src="/assets/default/img/icons/check.svg">{{ trans('home.contributor_text3') }}</p>
                </div>
                
            </div>
        </div>
        <div style="display: flex; align-items: center;" class="row mt-0 p-20 pl-10 pr-10 p-lg-40 pl-lg-80 pr-lg-80">
            <div style="padding: 20px" class="col-lg-6 col-12 order-lg-1 order-2">
                <h1 class="text-secondary font-weight-bold">{{ trans('home.learner_title') }}</h1>
                <p style="font-size: 16px;" class="slide-hint text-gray mt-20 mb-20">{{ trans('home.learner_hint') }}</p>
                <div class="ml-lg-10 mt-15">                
                    <p class="slide-hint text-gray second"><img class="mr-lg-2" src="/assets/default/img/icons/check.svg">{{ trans('home.learner_text1') }}</p>
                </div>
                <div class="ml-lg-10 mt-15"> 
                    <p class="slide-hint text-gray second"><img class="mr-lg-2" src="/assets/default/img/icons/check.svg">{{ trans('home.learner_text2') }}</p>
                </div>
                <div class="ml-lg-10 mt-15">
                    <p class="slide-hint text-gray second"><img class="mr-lg-2" src="/assets/default/img/icons/check.svg">{{ trans('home.learner_text3') }}</p>
                </div>            
            </div>
            <div style="padding: 20px" class="col-lg-6 col-12 d-flex flex-column order-lg-2 order-1">
                <div style="flex-grow: 1;">
        ...
        {{-- @if($homeSection->name == \App\Models\HomeSection::$instructors and !empty($instructors) and !$instructors->isEmpty())
            <section class="home-sections container mt-50">
                <div class=" justify-content-between">
                    <div class=" text-center">
                        <h1 style="font-size: 48px; font-weight:800 !important;" class="text-secondary">{{ trans('home.best_instructors') }}</h1>
                        <p class="slide-hint text-gray mt-20 mb-50">{{ trans('home.instructors_hint') }}</p>
