                ...
                @if(!empty($unReadNotifications) and count($unReadNotifications))
                    ...
                    <div class="d-flex align-items-center p-15 border rounded-sm">
                        ...
                        <div class="ml-5">
                            ...
                            <a href="/panel/notifications/mark-all-as-read" class="read-action d-block mt-5 font-12 cursor-pointer text-hover-primary" data-title="{{ trans('update.convert_unread_messages_to_read') }}" data-confirm="{{ trans('update.yes_convert') }}">
