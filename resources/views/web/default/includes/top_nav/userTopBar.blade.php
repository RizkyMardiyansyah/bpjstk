@if(!empty($authUser))
    ...
    <div class="custom-dropdown navbar-auth-user-dropdown position-relative ml-20">
        ...
        <div class="custom-dropdown-body pb-10 li">
            ...
            <div class="dropdown-user-avatar d-flex align-items-center p-15 m-15 mb-10 rounded-sm border">
                ...
                <div class="ml-5">
                    ...
                    <span class="mt-5 text-gray font-12">{{ trans('panel.'.$authUser->role_name) }}</span>
                </div>
            </div>
...
@else
    <div class="d-flex align-items-center ml-md-10">
        ...
        <div class="navbar-auth-user-dropdown-item">
            <a href="/login?redirect={{ request()->url() }}" class="d-flex align-items-center px-15 py-15 text-dark-blue font-14 bg-transparent">
