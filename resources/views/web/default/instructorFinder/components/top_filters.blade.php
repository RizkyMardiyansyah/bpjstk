<div id="topFilters" class="bg-white mt-25 shadow-lg border border-gray300 rounded-sm p-10 p-md-20">
    <div class="row align-items-center">
        <div class="col-lg-6 d-block d-md-flex align-items-center justify-content-start my-25 my-lg-0">
