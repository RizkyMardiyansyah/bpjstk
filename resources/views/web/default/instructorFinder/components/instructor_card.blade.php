...
<a href="{{ $instructor->getProfileUrl() }}" class="">
    <div  class=" bg-white position-relative d-flex flex-wrap instructor-finder-card border border-gray300 rounded-sm py-25 mt-20">
        ...
        <div class="col-12 col-md-4 mt-10 mt-md-0 pt-10 pt-md-0 instructor-finder-card-right-side position-relative">
            ...
            {{-- <div class="d-flex align-items-center  mt-10">
                <a type="" href="{{ $instructor->getProfileUrl() }}?tab=appointments#booksession" class="btn btn-primary">Book Now</a>              
            </div> --}}
