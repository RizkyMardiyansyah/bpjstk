    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h1 class="mb-2 display-4 font-weight-bold">Learning Partner 360</h1>
                <h5 class="font-weight-normal text-muted-transparent">Interactive Learning Management Platform</h5>
              </div>
              All rights reserved for <a class="text-light bb" target="_blank" href="https://beranidigital.id/">Learning Partner 360</a>
            </div>
          </div>
            </div>
