    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ getAdminPanelUrl() }}/settings">{{ trans('admin/main.setting') }}</a></div>
        ...
        <div class="section-body li">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            @include('admin.settings.pages.tabs')
                            <form action="{{ getAdminPanelUrl() }}/pages/{{ !empty($page) ? $page->id.'/update' : 'store' }}" method="Post">
                                ...
                                <div class="form-group mt-15 not">
