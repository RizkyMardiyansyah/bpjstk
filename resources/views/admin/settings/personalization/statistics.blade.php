...
<div class="mt-3 li" id="others_personalization">
    ...
    <form action="{{ getAdminPanelUrl("/settings/personalization/statistics") }}" method="post">
        ...
        <div class="js-custom-statistics mb-4 {{ (!empty($itemValue) and !empty($itemValue['display_default_statistics'])) ? 'd-none' : '' }} li">
