                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center mb-2" width="120">
                                                ...
                                                @can('admin_users_edit')
                                                    <a href="{{ getAdminPanelUrl() }}/users/{{ $user->id }}/edit?redirect={{ request()->url() }}" class="btn-transparent  text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.edit') }}">
