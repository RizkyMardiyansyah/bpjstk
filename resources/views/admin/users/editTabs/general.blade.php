    ...
    <div class="row">
        <div class="col-12 col-md-6">
            <form action="{{ getAdminPanelUrl() }}/users/{{ $user->id .'/update' }}" method="Post">
                ...
                <div class="form-group">
                    <label>{{ trans('auth.experience') }}</label>

                    <div class="row m-0" style="width: 100%;">
                        <div class="col-6 pr-1 p-0">
                            <label class="input-label" for="experience_year">{{ trans('auth.year') }}:</label>
                            <input name="experience_year" type="text" value="{{ $user->experience_year }}" class="form-control @error('experience_year') is-invalid @enderror">
                        ...
                        <div class="col-6 pl-1 p-0">
                            ...
                            <input name="experience_month" type="text" value="{{ $user->experience_month }}" class="form-control @error('experience_month') is-invalid @enderror">
                    ...
                    <div class="form-group">
                        <label>{{ trans('auth.expertise') }}</label>
                        <input name="expertise" value="{{ $user->expertise }}" class="form-control @error('expertise') is-invalid @enderror"/>
                        @error('expertise')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        <label>{{ trans('auth.linkedin') }}</label>
                        <input name="linkedin" value="{{ $user->linkedin }}" class="form-control @error('linkedin') is-invalid @enderror"/>
                        @error('linkedin')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        <label>{{ trans('auth.reason') }}</label>
                        <textarea name="reason" rows="5" class="form-control @error('reason') is-invalid @enderror">{{ $user->reason }}</textarea>
                        @error('reason')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
