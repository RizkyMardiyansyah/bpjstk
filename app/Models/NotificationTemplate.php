...
class NotificationTemplate extends Model
{
    ...
    static $notificationTemplateAssignSetting = [
        ...
        'appointment' => ['new_appointment', 'new_appointment_link', 'appointment_reminder','meeting_reschedule','meeting_finished','meeting_canceled','meeting_accepted', 'new_appointment_session'],
        'diary' => ['send_feedback'],
