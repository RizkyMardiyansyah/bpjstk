...
class User extends Authenticatable
{
    ...
    public function getTypeOfSessionsAttribute($value)
    {
        $typeOfSessions = $value;
        if(is_string($typeOfSessions)) $typeOfSessions = explode(",", $typeOfSessions);
        if(!is_array($typeOfSessions)) return [];
        return  $typeOfSessions;
    }

    public function setTypeOfSessionsAttribute($value)
    {
        if(is_string($value)) $value = explode(",", $value);
        if(!is_array($value)) $value = [];
        $this->attributes['type_of_sessions'] = implode(",", $value);
    }
    ...
    public function isUser() // student
    {
    ...
    {
        return $this->hasMany($this, 'organ_id', 'id');
    }

    public function getSkills1()
    {
        return $this->hasMany($this, 'skills', '%Results Orientation & Execution%');
    }
    ...
    public function getDiaries()
    {
        ...
        return Diary::where('user_id', $this->id);
    }
