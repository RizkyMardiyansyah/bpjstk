...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!empty($user) and $user->status == User::$pending and $data['status'] == User::$active ) {
            $user->notify(new SendApprovalNotification($user));
        }
        ...
        // if (!empty($user) && $user->status == User::$pending) {
