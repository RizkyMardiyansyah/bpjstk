    ...
    */
    ...
    protected function validator(array $data)
    {
        ...
        $rules = [
            ...
            'experience_year' => 'required_if:account_type,teacher',
            'experience_month' => 'required_if:account_type,teacher',
            'expertise' => 'required_if:account_type,teacher',
            'linkedin' => 'required_if:account_type,teacher',
            'reason' => 'required_if:account_type,teacher',
