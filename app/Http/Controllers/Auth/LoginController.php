...
class LoginController extends Controller
{
    ...
    */
    ...
    public function waitingForApprove(){
        return view('web.default.auth.waiting_for_approval');
    }
    ...
    protected function sendPendingResponse($user)
    {
        $toastData = [
            'title' => trans('public.request_failed'),
            'msg' => trans('auth.login_failed_your_account_is_waiting_for_approval'),
            'status' => 'warning'
        ];
