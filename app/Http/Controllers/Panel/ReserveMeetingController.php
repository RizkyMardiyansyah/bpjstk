...
class ReserveMeetingController extends Controller
{
    public function reservation(Request $request)
    {
        ...
        foreach ($reserveMeetings as $ReserveMeeting) {
            ...
            if ($ReserveMeeting->end_at < strtotime($current)) {
                if($ReserveMeeting->status!==ReserveMeeting::$finished){
    ...
    public function requests(Request $request)
    {
        ...
        //     // ->toArray();
            ...
            $activeMeetingTimeIds = ReserveMeeting::where('meeting_id', $meetingIds)
            ->where('status', ReserveMeeting::$open)
            ->whereHas('sale', function ($query) {
                $query->whereNull('refund_at');
            })
    ...
    public function accept($id)
    {
        ...
        if (!empty($ReserveMeeting)) {
            ...
            sendNotification('meeting_accepted', $notifyOptions, $ReserveMeeting->meeting->creator_id);
