        ...
        if (!empty($user)) {
            ...
            //     }
                ...
                $updateData = [
                    ...
                    "type_of_sessions" => !empty($data['type_of_sessions']) ? $data['type_of_sessions'] : null,
                ...
                // validate type_of_sessions
                if (!empty($data['type_of_sessions'])) {
                    $allowedValues = User::$typeOfSessions;
                    $data['type_of_sessions'] = array_intersect($data['type_of_sessions'], $allowedValues);
                }
