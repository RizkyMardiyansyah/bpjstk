...
(function ($) {
      ...
      if (result && result.code === 200) {
        ...
        setTimeout(function () {
          if (result.redirect_url && result.redirect_url !== '') {
            window.location.href = result.redirect_url + '#btncontainer';
          } else {
            window.location.reload(); window.location.hash = '#btncontainer';
          }
        }, 2000);
      }
    }).fail(function (err) {
  ...
  $('body').on('click', '.js-edit-quiz-form', function (e) {
    e.preventDefault();
    var $this = $(this);
    var form = $this.closest('.quiz-form');
    var data = serializeObjectByTag(form);
  ...
  $('body').on('click', '.js-submit-sent-form', function (e) {
    e.preventDefault();
    var $this = $(this);
    var form = $this.closest('.quiz-form');
    var data = serializeObjectByTag(form);
    ...
    $.post(action, data, function (result) {
      if (result && result.code === 200) {
        Swal.fire({
          icon: 'success',
          html: '<h3 class="font-20 text-center text-dark-blue">' + sentSuccessLang + '</h3>',
          showConfirmButton: false
        });
        setTimeout(function () {
          if (result.redirect_url && result.redirect_url !== '') {
  ...
  $('body').on('click', '.js-submit-share-form', function (e) {
    e.preventDefault();
    var $this = $(this);
    var form = $this.closest('.quiz-form');
    var data = serializeObjectByTag(form);
