(function ($) {
  ...
  * */
  ...
  $('body').on('click', '.read-action', function (e) {
    var _$$attr, _$$attr2;
    ...
    var title = (_$$attr = $(this).attr('data-title')) !== null && _$$attr !== void 0 ? _$$attr : deleteAlertHint;
    var confirm = (_$$attr2 = $(this).attr('data-confirm')) !== null && _$$attr2 !== void 0 ? _$$attr2 : deleteAlertConfirm;
    var html = '<div class="">\n' + '    <p class="">' + title + '</p>\n' + '    <div class="mt-30 d-flex align-items-center justify-content-center">\n' + '        <button type="button" id="swlRead" data-href="' + href + '" class="btn btn-sm btn-primary">' + confirm + '</button>\n' + '        <button type="button" class="btn btn-sm btn-danger ml-10 close-swl">' + deleteAlertCancel + '</button>\n' + '    </div>\n' + '</div>';
    Swal.fire({
      title: deleteAlertTitle,
      html: html,
      icon: 'warning',
  ...
  $('body').on('click', '#swlRead', function (e) {
    e.preventDefault();
    var $this = $(this);
    var href = $this.attr('data-href');
    $this.addClass('loadingbar primary').prop('disabled', true);
