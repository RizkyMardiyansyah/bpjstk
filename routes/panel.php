...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share', 'check_maintenance']], function () {
    ...
    //     Route::post('/', 'DiaryController');
    //     Route::post('/store', 'DiaryController@store');
    //     Route::get('/{id}/edit', 'DiaryController@edit');
    //     Route::post('/{id}/update', 'DiaryController@update');
    //     Route::get('/{id}', 'DiaryController@destroy');
    // });
    ...
    Route::group(['prefix' => 'meetings'], function () {
        ...
        Route::get('/{id}/delete', 'ReserveMeetingController@delete');
        Route::get('/{id}/accept', 'ReserveMeetingController@accept');
