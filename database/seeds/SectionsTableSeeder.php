...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Diary 3040 - 3049
        Section::updateOrCreate(['id' => 3040], ['name' => 'admin_diary', 'caption' => 'Diary']);
        Section::updateOrCreate(['id' => 3041], ['name' => 'admin_diary_lists', 'section_group_id' => 3040, 'caption' => 'Lists']);
        Section::updateOrCreate(['id' => 3042], ['name' => 'admin_diary_create', 'section_group_id' => 3040, 'caption' => 'Create']);
        Section::updateOrCreate(['id' => 3043], ['name' => 'admin_diary_edit', 'section_group_id' => 3040, 'caption' => 'Edit']);
        Section::updateOrCreate(['id' => 3044], ['name' => 'admin_diary_delete', 'section_group_id' => 3040, 'caption' => 'Delete']);
        Section::updateOrCreate(['id' => 3045], ['name' => 'admin_diary_exports', 'section_group_id' => 3040, 'caption' => 'Export Excel']);
